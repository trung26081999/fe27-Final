...
export default function MensClothing() {
    ...
    useEffect(() => {
        switch (feature) {
            case "fleeces":
                const fleecesMensClothing = productState.data.filter(item => item.feature === "fleeces");
                setProductList(fleecesMensClothing);
                break;

            case "gloves":
                const glovesMensClothing = productState.data.filter(item => item.feature === "gloves");
                setProductList(glovesMensClothing);
                break;
    ...
    return (<AppLayout>
        <>
            ...
            <H2>Featured products in Men´s clothing</H2>
